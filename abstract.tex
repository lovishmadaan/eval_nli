\begin{abstract}
In the recent past, a popular way of evaluating natural language understanding (or NLU), was to consider models' ability to do natural language inference (NLI) tasks. 
In this paper, we investigate if NLI tasks, that are rarely used for LLM evaluation, could still be informative in that context.

...
For MNLI and SNLI, we filter out the noisy samples for which there is no ground truth available for the evaluation. Additionally, we evaluate on the validation set of these two tasks because the human annotations in ChaosNLI \citep{nie-etal-2020-learn} are available for the subsets of the validation set. % Dieuwke: not entirely clear to me what this means

...
Contrary to Kullback Leibner divergence, JSD is symmetric and bound between 0 and 1, making it more interpretable for our specific case.
...
\begin{figure*}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[height=5cm]{figures/intermediate_jsd_mnli}
        \caption{}
    \end{subfigure}
    % \begin{subfigure}[b]{0.32\textwidth}
    %     \includegraphics[height=5cm]{figures/intermediate_jsd_snli}
    %     \caption{}
    % \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[height=5cm]{figures/intermediate_jsd_abductivenli}
        \caption{}
    \end{subfigure}

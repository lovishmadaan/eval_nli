...
Using the methodology used by \citet{dubey2024llama}, we analyse contamination by assigning a score to each evaluation sample which represents the percentage of tokens in the sample that is part of an 8-gram occurring in the pre-training dataset.
...
Since EPG is model-dependent, we use the 8B and 70B models we trained from scratch to observe the effect of contamination with our custom pre-training datamix.
...
% However, as the `clean' partition of the dataset at these thresholds is low, it is not possible to do proper significance testing.
...
% 
Thus, we believe that contamination does not play a participatory role in high performances for NLI benchmarks. %, and ANLI is the most challenging out of the five benchmarks we consider.
...
% Commented out because it was integrated in another figure
% \begin{figure*}[t]
%     \centering
%     \begin{subfigure}[b]{0.18\textwidth}
%         \includegraphics[height=3.0cm]{figures/entropy_acc_abductivenli_8B}
%         % \caption{}
%     \end{subfigure}
%     \begin{subfigure}[b]{0.15\textwidth}
%         \includegraphics[height=3.0cm, trim=10 0 0 0, clip]{figures/entropy_acc_abductivenli_405B}
%         % \caption{}
%     \end{subfigure}
%     \begin{subfigure}[b]{0.15\textwidth}
%         \includegraphics[height=3.0cm, trim=10 0 0 0, clip]{figures/entropy_acc_mnli_matched_8B}
%         % \caption{}
%     \end{subfigure}
%     \begin{subfigure}[b]{0.15\textwidth}
%         \includegraphics[height=3.0cm, trim=10 0 0 0, clip]{figures/entropy_acc_mnli_matched_405B}
%         % \caption{}
%     \end{subfigure}
%     \begin{subfigure}[b]{0.15\textwidth}
%         \includegraphics[height=3.0cm, trim=10 0 0 0, clip]{figures/entropy_acc_snli_8B}
%         % \caption{}
%     \end{subfigure}
%     \begin{subfigure}[b]{0.15\textwidth}
%         \includegraphics[height=3.0cm, trim=10 0 0 0, clip]{figures/entropy_acc_snli_405B}
%         % \caption{}
%     \end{subfigure}
%     \caption{\textbf{Accuracy versus entropy.} We show how the accuracy of Llama 8B and Llama 405B changes as the entropy of the human label distributions increases. Accuracy-vs-entropy plots for all other models can be found in \cref{fig:entropy_accuracy_all}.}
%     \label{fig:entropy_accuracy}
% \end{figure*}
...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        ...
        \includegraphics[height=2.5cm, trim=10 30 0 0, clip]{figures/entropy_acc_abductivenli_8B}
        % \caption{}
        \end{subfigure}
        \begin{subfigure}[b]{0.35\textwidth}
            \includegraphics[height=2.5cm, trim=10 30 0 0, clip]{figures/entropy_acc_abductivenli_405B}
            % \caption{}
        \end{subfigure}\\
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[height=2.5cm, trim=10 30 0 0, clip]{figures/entropy_acc_mnli_matched_8B}
            % \caption{}
        \end{subfigure}
        \begin{subfigure}[b]{0.35\textwidth}
            \includegraphics[height=2.5cm, trim=10 30 0 0, clip]{figures/entropy_acc_mnli_matched_405B}
            % \caption{}
        \end{subfigure}\\
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[height=2.8cm, trim=10 0 0 0, clip]{figures/entropy_acc_snli_8B}
            % \caption{}
        \end{subfigure}
        \begin{subfigure}[b]{0.35\textwidth}
            \includegraphics[height=2.8cm, trim=10 0 0 0, clip]{figures/entropy_acc_snli_405B}
            % \caption{}
        \end{subfigure}

...
\begin{figure*}[t]
    ...
    \end{subfigure}
    \caption{\tetbf{Contamination results.} We show the EPG vs the percent of the evaluation dataset marked as contaminated according to different thresholds.}\label{fig:contamination}
\end{figure*}
